            ...
            await pool.query(
                ...
                if (err) {
                    if(err = 'error: Please delete all songs in the playlist before deleting the playlist') {
                        ...
                        res.send("<script>alert('Trigger: You must delete all songs in this playlist before deleting the playlist!');window.location.href='/dashMusician';</script>");
                    }
                } else {
                    alert('Trigger: Playlist successfully deleted!');
                    res.send("<script>alert('Trigger: Playlist successfully deleted!');window.location.href='/dashMusician';</script>");
                }
            })
        ...
        try {
            ...
            (err, results) => {
                ...
                if (results.rowCount > 0) {
                    ...
                    res.send("<script>alert('Trigger: song has been removed from playlist!');window.location.href='/dashMusician';</script>");
                }  else {
                    alert('Trigger: invalid song! please enter a song in that playlist.');
                    res.send("<script>alert('Trigger: invalid song! please enter a song in that playlist.');window.location.href='/dashMusician';</script>");
                }
